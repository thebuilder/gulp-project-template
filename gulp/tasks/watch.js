...
gulp.task('watch', function () {
	watch({glob:[config.src + config.jsDir + '*.js', "!" + config.src + config.jsDir + '*.spec.js'], name:"JS", emitOnGlob:false}, ['lint']);
	watch({glob:config.src + config.lessDir + '*.less', name:"LESS", emitOnGlob:false}, ['less']);
